    ...
    if (Roles.userIsInRole(Meteor.userId(), ["super-admin", "manage-users"])) {
      ...
      if (containsSuperAdmin) {
        throw new Meteor.Error(
          "bad-match",
          "You are not allowed to assign other roles to users LOL"
        );
      }
      ...
      if (!emailExists) {
        ...
        SSR.compileTemplate(
          "inviteEmail",
          Assets.getText("email/templates/invite.html")
        );
