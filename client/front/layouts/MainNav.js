      ...
      <div className="nav-wrapper">
        <div id="menu-button-mobile-wrapper">
          <div className="fixed-action-btn">
            <a
              ...
              className="right btn-floating btn-large waves-effect waves-light grey"
            >
              <FontAwesome
                name="bars"
                size="5x"
                className="menu-button-mobile-icon"
              />
            </a>
          </div>
        </div>
        <ul id="slide-out" className="side-nav times-font">
          <li className="menu-logo">
            <p className="center-align logo-font">
              <a href="/">ArtEx</a>
            </p>
          </li>
          <li>
          ...
          <li className={ActiveRoute.path("/aboutNo") && "active"}>
            <a className="grey-text text-darken-4" href="/aboutNo">
              Om
            </a>
          </li>
          <li className={ActiveRoute.path("/aboutEn") && "active"}>
            <a className="grey-text text-darken-4" href="/aboutEn">
              About
            </a>
          </li>
          <li>
          ...
          <li className={ActiveRoute.path("/program") && "active"}>
            <a className="grey-text text-darken-4" href="/program">
              Programinnhold
            </a>
          </li>
          <li className={ActiveRoute.path("/jury") && "active"}>
            <a className="grey-text text-darken-4" href="/jury">
              Faglig Råd
            </a>
          </li>
          <li className={ActiveRoute.path("/mentors") && "active"}>
            <a className="grey-text text-darken-4" href="/mentors">
              Mentorer
            </a>
          </li>
          <li className={ActiveRoute.path("/participants") && "active"}>
            <a className="grey-text text-darken-4" href="/participants">
              Deltakere
            </a>
          </li>
          <li className={ActiveRoute.path("/whoMayApply") && "active"}>
            <a className="grey-text text-darken-4" href="/whoMayApply">
              Hvem kan søke?
            </a>
          </li>
          <li className={ActiveRoute.path("/contact") && "active"}>
          ...
          <li className={ActiveRoute.path("/login") && "active"}>
            <a className="grey-text text-darken-4" href="/login">
              Logg inn
            </a>
          </li>
        </ul>
