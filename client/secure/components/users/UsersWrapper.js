      ...
      <div className="container">
        ...
        <div className="row">
          <div className="col s12">
            <ul className="tabs">
              <li className="tab col s3">
                <a className="active" href="#crewTab">
                  Crew
                </a>
              </li>
              <li className="tab col s3">
                <a href="#pendingInvitesTab">Pending Invites</a>
              </li>
              <li className="tab col s3">
                <a href="#applicantsTab">Applicants</a>
              </li>
              <li className="tab col s3">
          ...
          <div id="archiveTab" className="col s12">
            <ApplicantEmailList
              id={"archivedApplicantEmailList"}
              userList={archivedUserList}
            />
            <ul className="collection">
