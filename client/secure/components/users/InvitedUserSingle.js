				...
				<div className="col s8">
					<div className="col s4">
						<input 
							...
							type="checkbox" 
							readOnly={true} 
							checked={Roles.userIsInRole(this.props.user._id, ['manage-users'])}
							onClick={this.toggleManageUsers.bind(this)}
							className="filled-in"
						/>
						<label htmlFor="invitedCanManageUsers">Administrere brukere</label>
					</div>
					<div className="col s4">
						<input 
							...
							className="filled-in"
						/>
						<label htmlFor="invitedIsModerator">Faglig Råd</label>
					</div>
					<div className="col s4">
