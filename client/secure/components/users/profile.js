    ...
    Meteor.users.update(
      ...
      (error, result) => {
        if (error) {
          ...
          Bert.alert("Profile saved", "success", "fixed-top", "fa-smile-o");
        }
      }
    );
  }
  ...
  render() {
    ...
    return (
      <div className="container">
          ...
          <form className="col s12" onSubmit={this.handleSubmit.bind(this)}>
            ...
            <div className="row">
              <div className="input-field col s12">
                <label htmlFor="dateOfBirth" className="active">
                  Date of birth
                </label>
                <input
                  ref="dateOfBirth"
        ...
        <div className="section">
          <a
            onClick={this.resetUserPassword.bind(this)}
        ...
        <div className="section">
          <a
            onClick={this.destroyAccount.bind(this)}
